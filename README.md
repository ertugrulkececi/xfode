...
| Model | MF type | Description |
|-------|---------|-------------|
| xFODE-PS1 | TriMF | Partitioned with triangular MFs |
| xFODE-PS2 | Gauss2MF | Partitioned with two-sided Gaussian MFs |
| xFODE-PS3 | Complementary Gauss2MF | Partitioned with complementary Gauss2MFs |
| AFODE | GaussMF | Additive FODE, no partitioning |

Baselines (FODE and NODE) are included for reproducibility.
