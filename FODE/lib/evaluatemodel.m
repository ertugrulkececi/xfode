function ypred = evaluatemodel(t, mini_batch_inputs, learnable_parameters,  number_mf, number_inputs,number_outputs, mbs, PP, output_membership_type)

if isdlarray(t)
   t = extractdata(t);
end

mini_batch_inputs = mini_batch_inputs';
