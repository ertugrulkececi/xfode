function [loss, gradients, yPred] = NODEfisModelLoss(timesteps, mini_batch_inputs, number_inputs, targets, number_outputs, number_mf, mbs, learnable_parameters, output_membership_type)

yPred = NODEmodel(timesteps, number_mf, mini_batch_inputs, number_inputs, number_outputs, learnable_parameters, mbs, output_membership_type);
